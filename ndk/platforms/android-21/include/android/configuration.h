...
enum {
    ...
    ACONFIGURATION_UI_MODE_NIGHT_YES_DK = 0x3,
    ACONFIGURATION_UI_MODE_NIGHT_NO_DK_WHITEOUT = 0x4,
    ACONFIGURATION_UI_MODE_NIGHT_NO_DK = 0x5,
    ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEOUT = 0x6,
    ACONFIGURATION_UI_MODE_NIGHT_YES_DK_BLACKOUT = 0x7,
    ACONFIGURATION_UI_MODE_NIGHT_YES_BLACKOUT = 0x8,
